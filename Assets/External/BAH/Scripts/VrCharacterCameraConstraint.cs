...
namespace BAHDOL
{
	...
	/// </summary>
	public class VrCharacterCameraConstraint : MonoBehaviour
	{
		/// <summary>
		...
		private VrSimpleCapsuleWithStickMovement _simplePlayerController;

		VrCharacterCameraConstraint()
		{
		...
		void Awake()
		{
			...
			_simplePlayerController = GetComponent<VrSimpleCapsuleWithStickMovement>();
		}
		...
		private void CameraUpdate()
		{
			...
			{
				//float camHeight = Mathf.Min(CameraRig.centerEyeAnchor.transform.localPosition.y, PreferredHeight);OLD CODE? BDM
