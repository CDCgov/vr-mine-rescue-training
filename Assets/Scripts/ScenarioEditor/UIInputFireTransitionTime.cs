...
public class UIInputFireTransitionTime : UIInspectorInputFieldBase
{
    ...
    protected override string GetComponentValue()
    {
        ...
        return VentFireInspector.TargetComponentInfo.TransitionTime.ToString("F3");
    }
    ...
    protected override bool UpdateComponentValue(string value)
    {
        ...
        VentFireInspector.TargetComponentInfo.TransitionTime = dblVal;
        return true;
    }
}
